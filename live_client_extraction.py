...
def build_gui():
    root = tb.Window(themename="darkly")  # Andere Themes: 'cyborg', 'solar', 'superhero', etc.
    ...
    # Log-Bereich
    log_area = scrolledtext.ScrolledText(root, width=85, height=17, font=("Consolas", 10), bg="#1e1e1e", fg="#eeeeee", insertbackground="#ffffff")
